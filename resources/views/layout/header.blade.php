                                    ...
                                    <div class="cart-wrap cart-on-mobile d-lg-none">
                                        ...
                                        <div class="cart-items">
                                            <div class="cart-item">
                                                <div class="cart-img">
                                                    <a href="#">
                                                        <img src="{{asset('themes/img/product/top-product1.jpg')}}" alt="product" class="img-fluid">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="cart-item">
                                                <div class="cart-img">
                                                    <a href="#">
                                                        <img src="{{asset('themes/img/product/top-product2.jpg')}}" alt="product" class="img-fluid">
                                                    </a>
                                                </div>
                                                <div class="cart-title">
                                            ...
                                            <div class="cart-item">
                                                <div class="cart-img">
                                                    <a href="#">
                                                        <img src="{{asset('themes/img/product/top-product3.jpg')}}" alt="product" class="img-fluid">
                                                    </a>
                                                </div>
                                                <div class="cart-title">
                                                    <a href="#">Microscope</a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 d-none d-lg-block">
                        <div class="site-logo-desktop">
                            <a href="index.html" class="main-logo"><img src="{{asset('themes/img/logo-dark.png')}}" alt="Site Logo"></a>
                        </div>
                    </div>
                    <div class="col-lg-4">
