        ...
        <div class="container">
            <div class="rc-carousel nav-control-layout2" data-loop="true" data-items="30" data-margin="5"
                ...
                <div class="ranna-slider-content-layout1">
                    <figure class="item-figure"><a href="{{----}}single-recipe1.html"><img src="{{asset('themes/img/slider/slide1-1.jpg')}}" alt="Product"></a></figure>
                ...
                <div class="ranna-slider-content-layout1">
                    <figure class="item-figure"><a href="{{----}}single-recipe1.html"><img src="{{asset('themes/img/slider/slide1-2.jpg')}}" alt="Product"></a></figure>
                    <div class="item-content">
                        <span class="sub-title">SALAD</span>
                        <h2 class="item-title"><a href="{{----}}single-recipe1.html">Italiano Salad Mixed</a></h2>
                        <ul class="item-rating">
                ...
                <div class="ranna-slider-content-layout1">
                    <figure class="item-figure"><a href="{{----}}single-recipe1.html"><img src="{{asset('themes/img/slider/slide1-3.jpg')}}" alt="Product"></a></figure>
                    <div class="item-content">
                        <span class="sub-title">SALAD</span>
                        <h2 class="item-title"><a href="{{----}}single-recipe1.html">Italiano Salad Mixed</a></h2>
                        <ul class="item-rating">
